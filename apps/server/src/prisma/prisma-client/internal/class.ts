...
const config: runtime.GetPrismaClientConfig = {
  "generator": {
    ...
    "output": {
      "value": "/Users/niteshseram/Developer/work/graphql-relay-server/src/prisma/prisma-client",
      "fromEnvVar": null
    },
    "config": {
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/niteshseram/Developer/work/graphql-relay-server/src/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativePath": "..",
  ...
  "inlineSchemaHash": "57115460a2b2ff3d60956517f681c2173bfc59f14a1f3faff69f20682d2214a8",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
   ...
   * `prisma.caughtPokemon`: Exposes CRUD operations for the **CaughtPokemon** model.
    ...
    * ```
    */
  get caughtPokemon(): Prisma.CaughtPokemonDelegate<ExtArgs, { omit: OmitOpts }>;
}
